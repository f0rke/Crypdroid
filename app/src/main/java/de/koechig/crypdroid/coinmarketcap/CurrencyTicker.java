...
public class CurrencyTicker implements Serializable, Parcelable {
    ...
    public final static Parcelable.Creator<CurrencyTicker> CREATOR = new Creator<CurrencyTicker>() {
        @SuppressWarnings({
                "unchecked"
        })
        public CurrencyTicker createFromParcel(Parcel in) {
            return new CurrencyTicker(in);
        }

        public CurrencyTicker[] newArray(int size) {
            return (new CurrencyTicker[size]);
        }
    };
    private final static long serialVersionUID = -6803997090436243518L;

    protected CurrencyTicker(Parcel in) {
